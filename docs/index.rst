...
* Cannon camera compatible with Cannon's [ccapi](https://asia.canon/en/campaign/developerresources/sdk#digital-camera)
* Turn table using Keigan Motor compatible wit Keigan's [pykeigan](https://github.com/keigan-motor/pykeigan_motor)
